...
const DOUBLE_ATTACKS_EFFECT = 'DOUBLE_ATTACKS'
const DOUBLE_DEFENDS_EFFECT = 'DOUBLE_DEFENDS'
const DOUBLE_SKILLS_EFFECT = 'DOUBLE_SKILLS'
const DOUBLE_BLOCK_EFFECT = 'DOUBLE_BLOCK'
...
const COMBO_EFFECT = 'COMBO_EFFECT'
const MAX_COMBO_EFFECT = 'MAX_COMBO_EFFECT'
...
const CINDERING_STATUS = 'CINDERING'
...
const INTERRUPT_EFFECT = 'INTERRUPT'
